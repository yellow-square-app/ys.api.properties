...
/// <summary>
/// Represents the data transfer object (DTO) used to update an existing property.
/// Contains the necessary details such as the Name, Description, and location coordinates of the property to be updated.
/// </summary>
